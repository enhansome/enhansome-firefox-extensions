# Awesome Firefox extensions with stars

*Please read [contribution guidelines](contributing.md) before contributing.*

## Developer

* [Octotree](https://github.com/buunguyen/octotree) ⭐ 23,245 | 🐛 33 | 🌐 JavaScript | 📅 2024-06-06 - Gives a file tree view on the side of each repository that you visit that you can use to navigate over the codebase.
* [Redux Devtools](https://github.com/zalmoxisus/redux-devtools-extension) ⭐ 13,446 | 🐛 265 | 🌐 JavaScript | 📅 2023-11-07 - Adds debugging for Redux to Chrome Dev tools.
...
* [uBlock Origin](https://github.com/gorhill/uBlock#ublock-origin) ⭐ 67,787 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-12 - Probably the best adblocker for Firefox there is.
* [Dark Reader](https://github.com/darkreader/darkreader) ⭐ 22,351 | 🐛 1,453 | 🌐 TypeScript | 📅 2026-09-11 - Inverts brightness of web pages and aims to reduce eyestrain while browsing the web.
* [Bitwarden](https://addons.mozilla.org/en-US/firefox/addon/bitwarden-password-manager/) - Secure and free password manager for all of your devices. Source code is available [here](https://github.com/bitwarden/browser/) ⭐ 13,771 | 🐛 1,314 | 🌐 TypeScript | 📅 2026-09-12. Note: For more security conscious viewpoint use Bitwarden.
* [Tridactyl](https://github.com/cmcaine/tridactyl) ⭐ 6,333 | 🐛 577 | 🌐 TypeScript | 📅 2026-09-12 - Vim like keyboard navigation like Vimperator/Pentadactyl.
* [Reddit Enhacement Suite](https://github.com/honestbleeps/Reddit-Enhancement-Suite) ⭐ 4,516 | 🐛 683 | 🌐 JavaScript | 📅 2026-09-04 - Includes many features that enhances your Reddit browsing experience.
...
* [NoScript](https://addons.mozilla.org/en-US/firefox/addon/noscript/) - The best security you can get in a web browser! Used for protection against XSS and other web security exploits. Source code is available [here](https://github.com/hackademix/noscript/) ⭐ 1,145 | 🐛 339 | 🌐 JavaScript | 📅 2026-08-19.
* [Tab search](https://github.com/reblws/tab-search) ⭐ 164 | 🐛 51 | 🌐 JavaScript | 📅 2026-03-16 - Keyboard-accessible tab management.
...
* [Dat-Firefox](https://github.com/sammacbeth/dat-fox) ⭐ 247 | 🐛 42 | 🌐 JavaScript | 📅 2022-12-07 - dat:// protocol as a Firefox webextension.

## Related

* [Awesome browser extensions for GitHub](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,301 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18.
