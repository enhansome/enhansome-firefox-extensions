...
* [Octotree](https://github.com/buunguyen/octotree) ⭐ 23,250 | 🐛 33 | 🌐 JavaScript | 📅 2024-06-06 - Gives a file tree view on the side of each repository that you visit that you can use to navigate over the codebase.
...
* [uBlock Origin](https://github.com/gorhill/uBlock#ublock-origin) ⭐ 67,950 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-18 - Probably the best adblocker for Firefox there is.
* [Dark Reader](https://github.com/darkreader/darkreader) ⭐ 22,373 | 🐛 1,452 | 🌐 TypeScript | 📅 2026-09-17 - Inverts brightness of web pages and aims to reduce eyestrain while browsing the web.
* [Bitwarden](https://addons.mozilla.org/en-US/firefox/addon/bitwarden-password-manager/) - Secure and free password manager for all of your devices. Source code is available [here](https://github.com/bitwarden/browser/) ⭐ 13,805 | 🐛 1,261 | 🌐 TypeScript | 📅 2026-09-18. Note: For more security conscious viewpoint use Bitwarden.
* [Tridactyl](https://github.com/cmcaine/tridactyl) ⭐ 6,343 | 🐛 579 | 🌐 TypeScript | 📅 2026-09-18 - Vim like keyboard navigation like Vimperator/Pentadactyl.
