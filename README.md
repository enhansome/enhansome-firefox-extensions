...
* [Redux Devtools](https://github.com/zalmoxisus/redux-devtools-extension) ⭐ 13,451 | 🐛 265 | 🌐 JavaScript | 📅 2023-11-07 - Adds debugging for Redux to Chrome Dev tools.
...
* [Lovely Forks](https://github.com/musically-ut/lovely-forks) ⭐ 672 | 🐛 16 | 🌐 JavaScript | 📅 2026-06-22 - Shows notable forks of GitHub repositories under their names.
...
* [uBlock Origin](https://github.com/gorhill/uBlock#ublock-origin) ⭐ 67,632 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-07 - Probably the best adblocker for Firefox there is.
* [Dark Reader](https://github.com/darkreader/darkreader) ⭐ 22,336 | 🐛 1,447 | 🌐 TypeScript | 📅 2026-09-07 - Inverts brightness of web pages and aims to reduce eyestrain while browsing the web.
* [Bitwarden](https://addons.mozilla.org/en-US/firefox/addon/bitwarden-password-manager/) - Secure and free password manager for all of your devices. Source code is available [here](https://github.com/bitwarden/browser/) ⭐ 13,759 | 🐛 1,306 | 🌐 TypeScript | 📅 2026-09-07. Note: For more security conscious viewpoint use Bitwarden.
* [Tridactyl](https://github.com/cmcaine/tridactyl) ⭐ 6,331 | 🐛 571 | 🌐 TypeScript | 📅 2026-09-07 - Vim like keyboard navigation like Vimperator/Pentadactyl.
* [Reddit Enhacement Suite](https://github.com/honestbleeps/Reddit-Enhancement-Suite) ⭐ 4,514 | 🐛 683 | 🌐 JavaScript | 📅 2026-09-04 - Includes many features that enhances your Reddit browsing experience.
...
* [NoScript](https://addons.mozilla.org/en-US/firefox/addon/noscript/) - The best security you can get in a web browser! Used for protection against XSS and other web security exploits. Source code is available [here](https://github.com/hackademix/noscript/) ⭐ 1,143 | 🐛 339 | 🌐 JavaScript | 📅 2026-08-19.
...
* [Awesome browser extensions for GitHub](https://github.com/stefanbuck/awesome-browser-extensions-for-github) ⭐ 3,298 | 🐛 26 | 🌐 JavaScript | 📅 2024-08-18.
